...
describe("QuarterFormSelect conversion tests", () => {
  ...
  test("fromNumericYYYYQ correctly throws errors", () => {
    expect(() => {
      fromNumericYYYYQ("20211");
    }).toThrow("param should be a number");
    expect(() => {
      fromNumericYYYYQ(2021);
    }).toThrow("param should be five digits");
    expect(() => {
      fromNumericYYYYQ(20210);
    }).toThrow("param should end in 1,2,3 or 4");
    expect(() => {
      fromNumericYYYYQ(20215);
    }).toThrow("param should end in 1,2,3 or 4");
  });
  ...
  test("toNumericYYYYQ correctly throws errors", () => {
    expect(() => {
      toNumericYYYYQ(20211);
    }).toThrow("param should be a string");
    expect(() => {
      toNumericYYYYQ("2021");
    }).toThrow("param should be five digits");
    expect(() => {
      toNumericYYYYQ("20210");
    }).toThrow("param should end in 1,2,3 or 4");
    expect(() => {
      toNumericYYYYQ("20215");
    }).toThrow("param should end in 1,2,3 or 4");
  });

  test("quarterRange correctly computes ranges", () => {
    expect(quarterRange("20211", "20222")).toStrictEqual([
      { yyyyq: "20211", qyy: "W21" },
      { yyyyq: "20212", qyy: "S21" },
      { yyyyq: "20213", qyy: "M21" },
      { yyyyq: "20214", qyy: "F21" },
    ...
    expect(quarterRange("20211", "20211")).toStrictEqual([
      { yyyyq: "20211", qyy: "W21" },
    ]);
