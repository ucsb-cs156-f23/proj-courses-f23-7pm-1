...
describe("utils/useBackend tests", () => {
  ...
  test("useBackend handles 404 error correctly", async () => {
    ...
    const messageA =
      "useBackend: Error communicating with backend via GET on /api/admin/users: Error: Request failed with status code 404";
    const messageB =
      "Error communicating with backend via GET on /api/admin/users: Error: Request failed with status code 404";
