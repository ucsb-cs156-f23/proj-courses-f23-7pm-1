...
public class UCSBSubjectsControllerTests extends ControllerTestCase {
  ...
  public void api_UCSBSubjects_all__logged_out__returns_200() throws Exception {
    mockMvc.perform(get("/api/UCSBSubjects/all")).andExpect(status().isOk());
  }
  ...
  public void api_UCSBSubjects__user_logged_in__returns_a_subject_that_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/UCSBSubjects?subjectCode=ANTH"))
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_UCSBSubjects__user_logged_in__search_for_id_that_does_not_exist()
      throws Exception {
  ...
  public void api_todos_admin_all__admin_logged_in__returns_all_records() throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/UCSBSubjects/all")).andExpect(status().isOk()).andReturn();
  ...
  public void api_todos__user_logged_in__delete_by_id() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/UCSBSubjects?subjectCode=ANTH").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void api_todos__admin_logged_in__delete_all() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/UCSBSubjects/all").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
