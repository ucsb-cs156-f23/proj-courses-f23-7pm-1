...
public class UCSBGradeHistoryServiceTests {
  ...
  @Autowired private UCSBGradeHistoryService ucsbGradeHistoryService;
  ...
  public void test_getUrls() throws Exception {
    ...
    EXPECTED_URLS.add(
        "https://raw.githubusercontent.com/ucsb-cs156/UCSB_Grades/main/quarters/F09/ANTH.csv");
    ...
    this.mockRestServiceServer
        ...
        .andRespond(
            withSuccess(GradeHistoryFixtures.GITHUB_API_SAMPLE_JSON, MediaType.APPLICATION_JSON));
  ...
  public void test_getGradeData() throws Exception {
    String url =
        "https://raw.githubusercontent.com/ucsb-cs156/UCSB_Grades/main/quarters/F09/DANCE.csv";
    ...
    this.mockRestServiceServer
        ...
        .andExpect(header("Content-Type", MediaType.APPLICATION_JSON.toString()))
        .andRespond(
            withSuccess(GradeHistoryFixtures.SAMPLE_CSV_FILE_CONTENTS, MediaType.APPLICATION_JSON));
